...
function insert_db_data($con){
  ...
  //Kebab
  insert_menu_item($con, "Kebab", "Med bröd", "Kebab", "55");
  insert_menu_item($con, "Kebabrulle", "Med tunnbröd", "Kebab", "65");
  insert_menu_item($con, "Kebabtallrik", "Med pommes frites", "Kebab", "70");
